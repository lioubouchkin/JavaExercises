...
public class MyQueue {
	...
	private class QueueNode {
		MyTreeNode item = null;
		QueueNode next = null;
		
		public QueueNode( MyTreeNode treeNode ) {
			this.item = treeNode;
		}
	}
	 ...
	 */
	public void enqueue( MyTreeNode treeNode ) {
